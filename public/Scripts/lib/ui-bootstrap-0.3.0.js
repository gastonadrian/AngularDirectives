...
.directive('pagination', ['paginationConfig', function(paginationConfig) {
  return {
    ...
    template: '<div class="pagination"><ul class="pagination"><li ng-repeat="page in pages" ng-class="{active: page.active, disabled: page.disabled}"><a ng-click="selectPage(page.number)" href="javascript:;">{{page.text}}</a></li></ul></div>',
    replace: true,
    link: function(scope, element, attrs) {
